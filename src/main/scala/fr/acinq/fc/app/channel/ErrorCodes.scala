...
object ErrorCodes {
  ...
  final val ERR_NOT_ENOUGH_FIAT = "0011"
  final val ERR_HOSTED_INVALID_MARGIN = "0012"
  final val ERR_HOSTED_INVALID_ORACLE_PRICE = "0013"
  ...
  val knownHostedCodes: Map[String, String] = Map (
    ...
    ERR_NOT_ENOUGH_FIAT -> "ERR_NOT_ENOUGH_FIAT",
    ERR_HOSTED_INVALID_MARGIN -> "ERR_HOSTED_INVALID_MARGIN",
    ERR_HOSTED_INVALID_ORACLE_PRICE -> "ERR_HOSTED_INVALID_ORACLE_PRICE",
  )
}
