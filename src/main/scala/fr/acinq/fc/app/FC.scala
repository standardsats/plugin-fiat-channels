...
import fr.acinq.fc.app.rate.{BitfinexSource, BlockchainInfo24h}
...
class FC extends Plugin with RouteProvider {
  ...
  override def onKit(eclairKit: Kit): Unit = {
    ...
    rateOracleRef = eclairKit.system actorOf Props(classOf[RateOracle], eclairKit, new BlockchainInfo24h())
