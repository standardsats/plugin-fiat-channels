...
case class FCHedgeLiability(amount: MilliSatoshi, price: MilliSatoshi) extends fr.acinq.hedgebot.HedgeBotMessage {
  override def message: String = s"$amount:$price"
  override def senderEntity: String = "FC"
}